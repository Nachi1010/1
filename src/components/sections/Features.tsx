...
export const Features = () => {
  ...
  const features = {
    ...
    he: [
      {
        title: "™PracticsAI - הזדמנות ייחודית בעולם ה-AI",        description: "למה בעצם אין \"תואר ללימודי AI\" (או: יש מצב שחברת AI מובילה תעניק לי הכשרה מלאה??)",
      ...
      },
      {
        ...
        description: "העתיד נמצא ב-AI. כלל המסיימים בהצלחה ישולבו מיידית בחברתנו ובחברות ה-AI המובילות בישראל. בהתחייבות.",
